...
python crab.py -p pancakes_2017_mc_UL_NANO.py -o /store/group/lpcbacon/pancakes/tmp-PF/2017/UL/ -t pancakes-tmp-PF -i mc_2017_UL.txt --num-cores 4  -s EventAwareLumiBased \
    -n 100000 --work-area crab_projects_mc_2017 --max-memory 5000 

#python crab.py -p pancakes_2017_mc_UL_NANO.py -o /store/group/lpcbacon/pancakes/02/2017/UL/ -t pancakes-02 -i mc_2017_UL.txt --num-cores 4  -s FileBased \
#   -n 5 --work-area crab_projects_mc_2017 --max-memory 5000
...
python crab.py -p pancakes_2017_mc_NANO.py -o /store/group/lpcbacon/pancakes/tmp-PF/2017/ -t pancakes-tmp-PF -i mc_2017.txt \
    --num-cores 4 --max-memory 5000 --send-external -s EventAwareLumiBased -n 50000 --work-area crab_projects_mc_2017
