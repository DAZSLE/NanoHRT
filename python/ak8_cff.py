...
def setupCustomizedAK8(process, runOnMC=False, path=None):
    ...
    process.customAK8SubJetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
        ...
        variables=cms.PSet(P4Vars,
            btagDeepB=Var("bDiscriminator('pfDeepCSVJetTags:probb')+bDiscriminator('pfDeepCSVJetTags:probbb')", float, doc="DeepCSV b+bb tag discriminator", precision=10),
            btagCSVV2=Var("bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags')", float, doc=" pfCombinedInclusiveSecondaryVertexV2 b-tag discriminator (aka CSVV2)", precision=10),
            btagDeepFlavB=Var("bDiscriminator('pfDeepFlavourJetTags:probb')",float,doc="DeepFlavour b tag discriminator",precision=10),
            btagDeepFlavBB=Var("bDiscriminator('pfDeepFlavourJetTags:probbb')",float,doc="DeepFlavour bb tag discriminator",precision=10),
            btagDeepFlavLepB=Var("bDiscriminator('pfDeepFlavourJetTags:problepb')",float,doc="DeepFlavour lepb tag discriminator",precision=10),
            btagDeepFlavC=Var("bDiscriminator('pfDeepFlavourJetTags:probc')",float,doc="DeepFlavour charm tag discriminator",precision=10),
            btagDeepFlavL=Var("bDiscriminator('pfDeepFlavourJetTags:probuds')",float,doc="DeepFlavour light tag discriminator",precision=10),
            btagDeepFlavG=Var("bDiscriminator('pfDeepFlavourJetTags:probg')",float,doc="DeepFlavour g tag discriminator",precision=10),
            rawFactor=Var("1.-jecFactor('Uncorrected')", float, doc="1 - Factor to get back to raw pT", precision=6),
            area=Var("jetArea()", float, doc="jet catchment area, for JECs", precision=10),
            nBHadrons=Var("jetFlavourInfo().getbHadrons().size()", int, doc="number of b-hadrons"),
            nCHadrons=Var("jetFlavourInfo().getcHadrons().size()", int, doc="number of c-hadrons"),
